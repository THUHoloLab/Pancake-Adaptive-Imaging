...
class TrainablePathSD2(nn.Module, SD2Enhancer):
    ...
    def init_text_models(self):
        ...
        print(f"[INFO] init_text_models on {self.text_device}, dtype={self.weight_dtype}")
    ...
    def init_vae(self):
        ...
        print(f"[INFO] init_vae on {self.vae_device}, dtype={self.weight_dtype}")
    ...
    def init_generator(self):
        ...
        print(f"[INFO] init_generator on {self.generator_device}, dtype={self.weight_dtype}")
        ...
        def _load_state_dict(path: str):
            try:
                ...
                try:
                    ...
                    raise RuntimeError(f"Failed to load HYPIR weight {path}: {e}")
